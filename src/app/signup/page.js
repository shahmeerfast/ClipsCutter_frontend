          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-center gap-2 text-sm text-gray-600">
              <input
                ...
                onChange={handleChange}
                className="accent-[#5271FF]"
              />
              <span>
                I agree to the{' '}
                <a href="/privacy-policy" className="text-[#5271FF] hover:underline">Privacy Policy</a>{' '}
                and{' '}
                <a href="/terms-of-service" className="text-[#5271FF] hover:underline">Terms of Service</a>.
              </span>
            </label>
            <button
              type="submit"
            ...
            <p className="text-sm text-gray-600 text-center">
              ...
              <a href="/login" className="text-[#5271FF] hover:underline">Login</a>
            </p>
